<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="科室" prop="attribute">
        <el-input
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['hushizhan:sickroom:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['hushizhan:sickroom:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['hushizhan:sickroom:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['hushizhan:sickroom:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="sickroomList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="科室" align="center" prop="attribute" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="科室" prop="attribute">
          <el-input v-model="form.attribute" placeholder="请输入科室" />
        </el-form-item>
...
<script>
import { listSickroom, getSickroom, delSickroom, addSickroom, updateSickroom } from "@/api/hushizhan/sickroom";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除病房记录表编号为"' + ids + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('hushizhan/sickroom/export', {
        ...this.queryParams
