  ...
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['feiyonggaunli:detail:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['feiyonggaunli:detail:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['feiyonggaunli:detail:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['feiyonggaunli:detail:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="接诊记录id" prop="receiveRecordId">
          <el-input v-model="form.receiveRecordId" placeholder="请输入接诊记录id" />
        </el-form-item>
        <el-form-item label="消费事项" prop="partName">
...
<script>
import { listDetail, getDetail, delDetail, addDetail, updateDetail } from "@/api/feiyonggaunli/detail";
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        receiveRecordId: [
          { required: true, message: "接诊记录id不能为空", trigger: "blur" }
        ],
        partName: [
          { required: true, message: "消费事项不能为空", trigger: "blur" }
        ],
      }
    };
  },
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除患者费用明细表编号为"' + ids + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('feiyonggaunli/detail/export', {
        ...this.queryParams
